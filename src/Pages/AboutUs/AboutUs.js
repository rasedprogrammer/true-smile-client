				...
				<div className="hero-content flex-col mt-20 lg:flex-row">
					...
					<div className=" ml-16">
						<h1 className="text-5xl font-bold ">
							I am Care For <br /> Your Dental Health
						</h1>
						<p className="py-6">
							I will probably instruct and teach the exceptionally imperative
						...
						<p className="py-6">
							best-in-class dental innovation, and in particular our proceeding
							with an expert training program for every one of the individuals
							from our dental group has a noteworthy influence in achieving that
							objective.
						</p>
					</div>
				</div>
