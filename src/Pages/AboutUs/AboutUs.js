			...
			<div className="hero-content flex-col lg:flex-row">
				...
				<div className=" ml-16">
					...
					<p className="py-6">
						...
						estimation of oral wellbeing and what every single patient can do to
						keep his or her teeth solid during their lifetime. We are committed
						to offering our patients great dentistry in a minding and delicate
						way.
					</p>
					<p className="py-6">
